...
- **文件管理** — 浏览设备文件系统，支持拖拽导入推送文件、勾选批量导出（拉取）到本地
- **APK 管理** — 浏览、筛选和批量删除本地 APK 文件
- **Firebase 监控** — 实时抓取和过滤 Firebase 事件日志
- **弱网限速代理** — 模拟延迟/限速/丢包，参数可在运行中实时生效，精确复现弱网环境
- **屏幕信息** — 一键查看设备屏幕尺寸、状态栏/刘海/导航栏占用、可用区域等信息，支持一键复制
- **设备别名管理** — 序列号映射为自定义别名，设备列表、文件命名等处直接显示别名，告别记 SN 号
